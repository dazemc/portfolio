    ...
    yield div(
      [
        button(
          ...
          classes: 'tab tab-lifted',
        ),
        button(
          [
            text('Tab 2'),
          ],
          classes: 'tab tab-lifted tab-active',
        ),
        button(
          [
            text('Tab 3'),
    ...
    yield div(
      [
        ...
        ul(
          ...
          classes:
              'p-2 menu dropdown-content bg-neutral text-neutral-content rounded-box w-52',
          attributes: {
            'tabindex': '0',
          },
        ),
